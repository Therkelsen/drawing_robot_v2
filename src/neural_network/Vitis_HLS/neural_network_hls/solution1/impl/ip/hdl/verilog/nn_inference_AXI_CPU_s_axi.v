...
#(parameter
    ...
    input  wire [6:0]                    input_img_address0,
...
localparam
    ...
    ADDR_IER            = 10'h008,
    ADDR_ISR            = 10'h00c,
    ADDR_OUT_R_DATA_0   = 10'h010,
    ADDR_OUT_R_CTRL     = 10'h014,
    ADDR_INPUT_IMG_BASE = 10'h200,
    ADDR_INPUT_IMG_HIGH = 10'h3ff,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [6:0]                    int_input_img_address0;
    ...
    wire [6:0]                    int_input_img_address1;
...
assign int_input_img_address1 = ar_hs? raddr[8:2] : waddr[8:2];
