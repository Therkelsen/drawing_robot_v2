...
// wrapc file define:
#define AUTOTB_TVIN_out_r "../tv/cdatafile/c.nn_inference.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out_r "../tv/cdatafile/c.nn_inference.autotvout_out_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.nn_inference.autotvout_out_r.dat"
...
extern "C" void apatb_nn_inference_hw(volatile void * __xlx_apatb_param_input_img, volatile void * __xlx_apatb_param_out_r) {
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          if (i > 0) {
            ((int*)__xlx_apatb_param_out_r)[0] = out_r_pc_buffer[0].to_int64();
          }
        } // end transaction
      } // end file is good
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_input_img)[j];
  ...
  tcl_file.set_num(100, &tcl_file.input_img_depth);
...
nn_inference_hw_stub_wrapper(__xlx_apatb_param_input_img, __xlx_apatb_param_out_r);
